  ...
  try {
    ...
    const rows = await db.insert(giveawaysTable).values([
      ...
      },
      {
        ...
        description: "Fifteen iconic expressions from the world-renowned Patrón distillery — from crisp Silver to the ultra-rare Gran Patrón Burdeos, plus the Roca collection, Estate Release, Ahumado, El Cielo, El Alto, Cristalino, Citrónge and XO Café. Professionally packed and shipped insured to your door.",
