            ...
            {featuredGiveaways.length > 1 && (
              <>
                ...
                <button
                  ...
                  className="absolute top-1/2 right-2 sm:right-3 -translate-y-1/2 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-black/15 hover:bg-primary text-white hover:text-primary-foreground backdrop-blur border border-white/10 hover:border-primary shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-105"
                >
