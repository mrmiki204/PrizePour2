        ...
        <div className="max-w-3xl mx-auto px-6 space-y-10">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <p>Purchasing additional tickets increases your probability of winning but does not guarantee a win. All ticket sales are final. Ticket packages are: 1 ticket ($4.99), 5 tickets ($19.99), 10 tickets ($34.99), and 25 tickets ($100.00). Maximum 25 tickets per person per draw unless otherwise stated.</p>
            </section>
